...
@Component({
  selector: 'ngx-noticedelconfirm',
  templateUrl: './noticedelconfirm.component.html',
  styleUrls: ['./noticedelconfirm.component.scss']
})
export class NoticedelconfirmComponent implements OnInit {
